                ...
                <div class="card card-outline card-info">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="{{ url('/usuarios/create')}}" class="btn btn-primary"><i class="bi bi-file-plus"></i>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <a href="{{ url('/usuarios', $usuario->id) }}" title="show" class="btn btn-outline-info"><i class="bi bi-eye"></i></a>

                                                <a href="{{ route('usuarios.edit', $usuario->id) }}" class="btn btn-outline-success"><i class="bi bi-pencil"></i></a>
